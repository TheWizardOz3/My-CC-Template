...
- **Skills** live in [.claude/skills/](.claude/skills/) — twelve user- and model-invocable workflows. See [README.md](README.md) for the full list.
...
- **Marketing skills** come from the upstream `coreyhaines31/marketingskills` plugin (install once per machine — see [README.md § Marketing capabilities](README.md#marketing-capabilities)). The project-side bridge that feeds them dev context lives at [.claude/skills/marketing-context/](.claude/skills/marketing-context/) and writes `.agents/product-marketing-context.md`.
